...
@section('content_header')
    <h1 class="text-center">Nuevo BIA</h1>
@stop
@section('content')
    <ol class="breadcrumb">
        <li class="breadcrumb-item"><a href="{{ route('admin.biaprocesses.index') }}">Lista de BIA</a></li>
        <li class="breadcrumb-item active" aria-current="page">Nuevo BIA</li>
    </ol>
    <div class="card">
        <div class="card-body">
            {!! Form::model('BiaProcess', ['route' => ['admin.biaprocesses.store'], 'method' => 'POST']) !!}
